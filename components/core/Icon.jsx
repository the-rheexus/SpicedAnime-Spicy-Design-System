 ...
 */
export function Icon({ name, size = 18, strokeWidth = 2, color = 'currentColor', style, spin = false, ...rest }) {
  ...
  return (
    <svg
      ...
      aria-hidden="true" data-icon={name}
      style={{ flex: 'none', display: 'block', animation: spin ? 'sa-spin 0.9s linear infinite' : undefined, ...style }}
