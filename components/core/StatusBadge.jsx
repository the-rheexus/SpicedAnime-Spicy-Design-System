...
export const DISPLAY_LABEL = {
  batches:   { 'Locked for Review': 'PPT Generated' },
  component: { 'Canceled': 'Print Not Needed' },
  reprint:   { 'Open': 'Awaiting batch' },
};
 ...
 */
export function StatusBadge({ status, label, context, size = 'md', dot = false, style, ...rest }) {
