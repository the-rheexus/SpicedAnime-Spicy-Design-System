...
export interface DataTableProps {
  ...
  /**
   * Restricts selection to these row keys. Rows outside the list render no
   * checkbox, and the header checkbox reflects and toggles only these rows —
   * use when some rows are ineligible for the bulk action. Omit to make every
   * row selectable.
   */
